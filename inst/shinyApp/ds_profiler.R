...
# TODO: create another demonstrator function
#   coxplSHLAMDS(profile = TRUE)
#   call coxph wrapped with profvis
#   return in string all the text
#   have ds.coxphSLMA prints this string
